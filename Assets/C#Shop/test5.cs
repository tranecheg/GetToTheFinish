...
namespace CompleteProject
{
    ...
    public class test5 : MonoBehaviour, IStoreListener
    {
        private static IStoreController m_StoreController;          // The Unity Purchasing system.
        private static IExtensionProvider m_StoreExtensionProvider;
		public int jewels;		// The store-specific Purchasing subsystems.
        ...
        public static string kProductIDConsumable =    "consumable_40";   
		public static string kProductIDConsumable1 =    "consumable_80";  
		 public static string kProductIDConsumable2 =    "consumable_160";  
