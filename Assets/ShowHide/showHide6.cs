...
public class showHide6 : MonoBehaviour
{
	 ...
	 public GameObject act3, enemy1_3, enemy2_3;
	  public GameObject act4, enemy1_4, enemy2_4;
	   public GameObject act5, enemy1_5, enemy2_5;
		...
		public GameObject act8, enemy1_8, enemy2_8;
		public GameObject act9, enemy1_9, enemy2_9;
    ...
    void Update()
    {
	  ...
	  //указываем начальную точку	
	   ...
	   //указываем конечную точку	
	    ...
	    if(player.transform.position.x - enemy2_8.transform.position.x>20){
	  ...
	  //указываем начальную точку	
	    if(enemy1_8.transform.position.x - player.transform.position.x>20){
		   act8.SetActive(false);
	   }
	   
	   //указываем конечную точку	
	   
	    if(player.transform.position.x - enemy2_9.transform.position.x>20){
		   act9.SetActive(false);
	   }
	   else{
		   act9.SetActive(true);
	   }
	  ...
	  //указываем начальную точку	
	    if(enemy1_9.transform.position.x - player.transform.position.x>20){
		   act9.SetActive(false);
	   }
